...
| **GraphCaster** | **частично** | Слой **B**: **@xyflow/react**, **`GcFlowNode`** / **`GcCommentNode`**, инспектор, предупреждения — **закрытые** срезы (**F18**, undo/redo, run-lock, sanitize, мини-карта, поиск, ПКМ-меню, мультивыбор, **производительность больших графов** волна 1, F13 оверлей, **CI**) — единый реестр в [`IMPLEMENTED_FEATURES.md`](IMPLEMENTED_FEATURES.md) (**«MiniMap…»**, **«Поиск…»**, **«Меню «Добавить ноду»…»**, **«Мультивыбор…»**, **«Canvas: большие графы»** и смежные разделы). **Остаток F1 / §28.2:** **lazy**-подграфы в схеме **A**, опционально «лёгкий» хром ноды вне вьюпорта после профиля; полная типизация пинов — **§15**. |
...
| **GraphCaster** | **@xyflow/react** | Канвас, инспектор, предупреждения, P1/P2, **MiniMap** / поиск / ПКМ-меню / мультивыбор, **большие графы** (волна 1), оверлей **F13**, **рамки `group`** / **Group selection** — реестр в [`IMPLEMENTED_FEATURES.md`](IMPLEMENTED_FEATURES.md) (**«MiniMap…»**, **«Поиск…»**, **«Меню «Добавить ноду»…»**, **«Мультивыбор…»**, **«Canvas: большие графы»**, **«Консоль наблюдаемости…»**, **«Открытие графа…»** и др.). В **§28.2** — планирование **остатка** только по **lazy**-подграфам в схеме **A** | **`GraphDocument`** + **`validate.py`**; без БД (**F23**) |
