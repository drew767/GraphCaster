...
**Дата:** 2026-03-29 · **итерация 66** (**§29**: опциональный subprocess для **`graph_ref`** вынесен в [`IMPLEMENTED_FEATURES.md`](IMPLEMENTED_FEATURES.md); **§32.2**: узкий **`$node`** в шаблонах и **`var`**; «открыто» — полный **n8n Expression** / JS sandbox)  
