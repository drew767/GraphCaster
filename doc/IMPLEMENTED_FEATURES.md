...
| Тесты | `ui/src/run/consoleLineMeta.test.ts`, `ui/src/run/buildRunTimeline.test.ts`, `ui/src/run/nodeRunOverlay.test.ts`, `ui/src/run/parseRunEventLine.test.ts` (**`peekRootGraphIdFromNdjson`**) (Vitest) |
