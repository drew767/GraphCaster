...
Сравнение с конкурентами и **остаток** F1 (опционально «лёгкий» хром ноды вне вьюпорта по профилю; **встраивание** дочернего JSON в слой **A** вне file-first — **§29**) — [`COMPETITIVE_ANALYSIS.md`](COMPETITIVE_ANALYSIS.md) **§28**, таблица **F1** (строка GraphCaster).
