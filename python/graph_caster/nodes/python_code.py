...
"""python_code node: subprocess-isolated Python execution via worker child interpreter."""
...
def execute_python_code(
    *,
    ...
    """Run user code in a child interpreter. Emits ``process_complete`` (exitCode 0/1)."""
    ...
    if len(code.encode("utf-8")) > _MAX_CODE_BYTES:
        ...
        return False, {
            "processResult": {"success": False, "exitCode": 1, "timedOut": False, "error": err},
            "codeResult": {"success": False, "error": err, "result": None},
        }
    ...
    try:
        ...
        return False, {
            "processResult": {"success": False, "exitCode": 1, "timedOut": True, "error": "timeout"},
    ...
    if proc.returncode != 0:
        ...
        ctx["last_result"] = False
        return False, {
            "processResult": {"success": False, "exitCode": 1, "timedOut": False, "error": msg},
    ...
    if not out_first:
        ...
        ctx["last_result"] = False
        return False, {
            "processResult": {"success": False, "exitCode": 1, "timedOut": False, "error": "empty_worker_stdout"},
    ...
    try:
        ...
        ctx["last_result"] = False
        return False, {
            "processResult": {"success": False, "exitCode": 1, "timedOut": False, "error": "invalid_worker_json"},
    ...
    if not isinstance(parsed, dict):
        ...
        ctx["last_result"] = False
        return False, {
            "processResult": {"success": False, "exitCode": 1, "timedOut": False, "error": "worker_bad_shape"},
    ...
    if not parsed.get("ok"):
        ...
        ctx["last_result"] = False
        return False, {
            "processResult": {"success": False, "exitCode": 1, "timedOut": False, "error": err_s},
            "codeResult": {
                "success": False,
                "error": err_s,
                "result": None,
...
class PythonCodeNode(GraphCasterNode):
    type: ClassVar[str] = "python_code"
    version: ClassVar[float] = 1.0
    display_name: ClassVar[str] = "Python Code"
    description: ClassVar[str] = "Run a Python snippet in an isolated subprocess"
    category: ClassVar[str] = "core"
    icon: ClassVar[str] = "code"

    inputs: ClassVar[list[Input]] = [
        Input("code", str, required=True, multiline=True),
        Input("timeoutSec", float, default=_DEFAULT_TIMEOUT, range=(0.5, 600.0)),
    ]
    outputs: ClassVar[list[Output]] = [
        Output("codeResult", "json"),
